...
# Import instructions
from instructions.truu_agent_instructions import instructions as truu_instructions
...
class TruUAgent(BaseAgent):
    def __init__(self):
        super().__init__(
            agent_name="TruUAgent",
            instructions=truu_instructions,
